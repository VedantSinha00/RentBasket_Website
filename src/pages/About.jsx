        ...
        <main className="w-full bg-white py-12 md:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <h1 className="font-display font-semibold text-3xl sm:text-4xl md:text-5xl text-foreground mb-3">
                About RentBasket
              </h1>
            ...
            <div className="flex flex-col items-center gap-6 sm:gap-4 mb-20 relative max-w-md mx-auto sm:max-w-none">
              ...
              <div className="relative bg-white border border-border shadow-soft rounded-[28px] w-full max-w-[420px] h-[120px] flex items-center pl-36 pr-6 sm:-translate-x-12 z-20">
                {/* Pastel identity block behind the cutout image */}
                <div className="absolute bottom-0 left-4 w-28 h-24 rounded-2xl bg-sand" aria-hidden="true" />
                ...
                <div className="flex flex-col justify-center select-none">
                  <h3 className="font-display font-semibold text-xl text-ink leading-tight">Vijay Mahendru</h3>
                  <p className="font-sans font-medium text-sm text-ink-muted mt-1">Founder</p>
                </div>
              </div>
              ...
              <div className="relative bg-white border border-border shadow-soft rounded-[28px] w-full max-w-[420px] h-[120px] flex items-center pr-36 pl-8 sm:translate-x-12 -mt-4 sm:-mt-6 z-10 self-end sm:self-auto">
                <div className="flex flex-col justify-center select-none">
                  <h3 className="font-display font-semibold text-xl text-ink leading-tight">Hardik Mahendru</h3>
                  <p className="font-sans font-medium text-sm text-ink-muted mt-1">Co-founder</p>
                </div>
                {/* Pastel identity block behind the cutout image */}
                <div className="absolute bottom-0 right-4 w-[110px] h-24 rounded-2xl bg-sky" aria-hidden="true" />
                {/* Portrait image overlapping out-of-bounds */}
            ...
            <div className="bg-cream shadow-card rounded-[32px] p-8 sm:p-12 md:p-16 max-w-3xl mx-auto">
              <h2 className="font-display font-semibold text-2xl sm:text-3xl text-ink mb-8 tracking-tight">
                Founding Team behind Rentbasket
              </h2>

              <div className="font-sans text-sm sm:text-base text-ink/90 leading-relaxed space-y-6">
                ...
                <p className="font-medium text-ink border-t border-border pt-6 mt-6">
