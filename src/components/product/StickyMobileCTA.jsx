      ...
      <div className="flex items-center justify-between px-4 py-3 gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-1.5">
            <span className="text-lg font-semibold text-jade-ink">
        ...
        <button
          ...
          className="btn-pine px-6 py-2.5 text-sm font-semibold whitespace-nowrap flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:grayscale"
        >
