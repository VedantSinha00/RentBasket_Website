...
const BookingSummary = ({ orderData }) => {
  ...
  return (
    <div className="w-full bg-card border border-border rounded-2xl shadow-card overflow-hidden mb-8">
      {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl border border-border/50 bg-background">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="mt-2 text-xs bg-secondary/40 px-2 py-1.5 rounded text-muted-foreground font-medium inline-block">
